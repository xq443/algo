...
public class SerializeandDeserializeNaryTree {
  ...
  public static void main(String[] args) {
    ...
    NaryNode root = new NaryNode(1, Arrays.asList(
        new NaryNode(3, Arrays.asList(
            new NaryNode(5),
            new NaryNode(6)
        )),
        new NaryNode(2),
    ...
    NaryNode deserialized = serializeandDeserializeNaryTree.deserialize(serialized);
    System.out.println("Deserialized Root Value: " + deserialized.value);  // Should be 1
  }
