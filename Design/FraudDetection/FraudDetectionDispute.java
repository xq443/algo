...
public class FraudDetectionDispute {
    ...
    public static void main(String[] args) {
      ...
      String[] mccThresholds = {"retail,0.8", "airline,0.25", "venue,0.25", "restaurant,0.8"};
      ...
      FraudDetectionDispute f = new FraudDetectionDispute();
