...
public class YoungTableau {
  ...
  public int extractMin() throws Exception {
    if(size == 0) throw new Exception("Matrix is Empty");
    int min = matrix[0][0];
  ...
  public void insert(int v) throws Exception {
    if(size == m * n) throw new Exception("Matrix has already been filled");
  ...
  public static void main(String[] args) throws Exception {
    YoungTableau yt = new YoungTableau(2, 3); // Create an empty 2x3 Young tableau
    try {
