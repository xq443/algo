...
public class findAllPossibleRecipeFromSupplies {
    public static List<String>  findAllPossibleRecipeFromSupplies(String[] recipes, List<List<String>> ingredients, String[] supplies){
        //build up the graph
        ...
        for (int i = 0; i < recipes.length; i++) {
            for (int j = 0; j < ingredients.get(i).size(); j++) {
                ...
                //next.get(ingredient).add(recipes[i]);
